        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="white-box">
                        <img src="<?php echo $item['image'] ?? "../images/grey.png" ?>" class="img-responsive img-big"
                             width="300px">
                        <p>
                        ...
                        <p style="padding-left: 30px;"><span
                                    style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 12pt; color: #000000;">♦ <span
                                        style="color: #ff0000;"><b><span
                                                style="color: #000000;">12 Months Genuine </span> Warranty <span
                                                style="color: #000000;"></span></b></span></span></p>
                        <p style="padding-left: 30px;"><span
                                    style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 12pt; color: #000000;">♦ <strong><span
                                            style="color: #ff0000;">Free</span> cleaning and installation support.</strong></span>
                        </p>
                        <p style="padding-left: 30px;"><span
                                    style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 12pt; color: #000000;"><strong>♦ <span
                                            style="color: #ff0000;">Free</span> transport.</strong></span>
                        </p>
                        <p style="padding-left: 30px;"><span
                                    style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 12pt; color: #000000;"><strong>♦ <span
                                            style="color: #ff0000;">Shockproof bag.</span></strong></span>
                        </p>
                    ...
                    <div class=" vc_custom_1600254371583">
                        ...
                        <table>
                            ...
                            <tr class="border-bottom border-secondary">
                                <th>Brand</th>
                                <td><p class="p-des"><?php echo $item['brand'] ?? "Apple" ?> </p>
                                </td>
                            </tr>

                            <tr class="border-bottom border-secondary">
                                <th>CPU</th>
                                <td><p class="p-des"><?php echo $item['CPU'] ?? "Intel Core i5 12500H" ?> </p>
                                </td>
                            </tr>
                            ...
                            <tr class="border-bottom border-secondary">
                                <th>GPU</th>
                                <td><p class="p-des"><?php echo $item['GPU'] ?? "Geforce RTX 3050 4GB" ?></p>
                                </td>
                            </tr>
                            <tr class="border-bottom border-secondary">
                                <th>Screen</th>
                            ...
                            <tr class="border-bottom border-secondary">
                                <th>MEM</th>
                                <td><p class="p-des"><?php echo $item['Mem'] ?? "512GB SSD NVMe M.2 PCIe Gen4" ?></p>
                                </td>
                            </tr>

                            <tr class="border-bottom border-secondary">
                                <th>Weight</th>
                                <td><p class="p-des"><?php echo $item['Weight'] ?? "2.45 kg" ?></p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
