...
<link rel="stylesheet" href="../style/style1.css">
    <div class="container">
        <div class="card des">
            <div class="card-body">
                <h3 class="card-title">Apple Macbook Pro M1 2020 (MYD82SA/A) Space Grey 13.3″ Retina 8-core CPU/8-core GPU 8GB 256GB SSD Touch</h3>
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-6">
                        <div class="white-box text-center"><img src="../images/grey.png" class="img-responsive" width="300px"></div>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-6">
                        ...
                        <h4 class="box-title mt-5">CPU: <span>Apple M1 with 8‑core CPU</span> </h4>
                        <h4 class="box-title mt-5">Operating System: <span>MacOS Big Sur</span> </h4>
                        <h4 class="box-title mt-5">GPU: <span>Apple M1 with 8‑core GPU</span> </h4>
                        <h4 class="box-title mt-5">Ram: <span>8GB Onboard</span> </h4>
                        <h2 class="mt-5">
                            28,990,990đ
                        </h2>
